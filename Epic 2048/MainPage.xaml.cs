 ...
 * 
 * Copyright (C) 2022 Willvin313@GitHub. All Rights Reserved.
 */

using Willvin.DataUtils;
using Willvin.InputUtils;
using System;
...
namespace Epic_2048
{
    public sealed partial class MainPage : Page
    {
        ...
        private void CustomizeTitleBar()
        {
            ...
            //appTitleBar.ButtonForegroundColor = (this.isSystemThemeDark == "black") ? Colors.Black : Colors.White;
        }

        private string isSystemThemeDark
        {
            get
            {
                var uiSettings = new UISettings();
                return uiSettings.GetColorValue(UIColorType.Background).ToString();
            }
        }
